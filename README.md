...
The **Scholarship Management System** is a full-stack web application built with **Laravel** and **Vue.js** designed to streamline the administration of scholarship programs. It provides secure authentication, user management, applicant tracking, and scholarship program administration — all wrapped in a modern, responsive interface.
